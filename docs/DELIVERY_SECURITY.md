...
still never sends HTTP. Retries use [bounded persisted scheduling](RETRIES.md); the opt-in [continuous worker](CONTINUOUS_WORKER.md)
processes due work automatically.
